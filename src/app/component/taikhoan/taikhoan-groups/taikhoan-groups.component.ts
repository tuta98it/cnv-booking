...
@Component({
  selector: 'app-taikhoan-groups',
  templateUrl: './taikhoan-groups.component.html',
  styleUrls: ['./taikhoan-groups.component.scss']
})
export class TaikhoanGroupsComponent implements OnInit, OnChanges {
  @Input() user: any;
  @Input() isVisible: any;
